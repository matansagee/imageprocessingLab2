...
public class SpatialFilteringActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSaveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(SpatialFilteringActivity.this, fileName + " saved", Toast.LENGTH_SHORT).show();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        nonLinearSubMenu.addSubMenu(FILTER_GROUP_ID, CameraListener.VIEW_MODE_BILATERAL,
                Menu.NONE,"Bilateral");
